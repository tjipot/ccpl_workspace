 ...
 * Description: self-defined header file, including common system header files,
 * common macros, self-defined utility functions.
 */
...
/*自定义函数原型, 以err_开头的是错误处理函数, 用于出错时打印提示信息并进行相关操作.*/
